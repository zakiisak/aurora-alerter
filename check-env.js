...
if (hasErrors) {
  ...
  console.log('2. Set BREVO_API_KEY to your actual Brevo API key');
  console.log('3. Get your API key from: https://app.brevo.com/settings/keys/api');
  ...
  console.log('1. Verify your API key is correct in Brevo dashboard');
